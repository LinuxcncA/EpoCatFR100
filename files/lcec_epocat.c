...
static const lcec_pindesc_t slave_params[] = {
	...
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_epocat_data_t, set_00_position), "%s.%s.%s.axis0-set-position" },
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_epocat_data_t, set_01_position), "%s.%s.%s.axis1-set-position" },
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_epocat_data_t, set_02_position), "%s.%s.%s.axis2-set-position" },
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_epocat_data_t, set_03_position), "%s.%s.%s.axis3-set-position" },
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_epocat_data_t, set_04_position), "%s.%s.%s.axis4-set-position" },

	{ HAL_BIT, HAL_RW, offsetof(lcec_epocat_data_t, update_00_position), "%s.%s.%s.axis0-update-position" },
	{ HAL_BIT, HAL_RW, offsetof(lcec_epocat_data_t, update_01_position), "%s.%s.%s.axis1-update-position" },
	{ HAL_BIT, HAL_RW, offsetof(lcec_epocat_data_t, update_02_position), "%s.%s.%s.axis2-update-position" },
	{ HAL_BIT, HAL_RW, offsetof(lcec_epocat_data_t, update_03_position), "%s.%s.%s.axis3-update-position" },
	{ HAL_BIT, HAL_RW, offsetof(lcec_epocat_data_t, update_04_position), "%s.%s.%s.axis4-update-position" },
